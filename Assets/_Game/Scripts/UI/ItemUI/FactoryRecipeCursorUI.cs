...
public class FactoryRecipeCursorUI : MonoBehaviour
{
    public static FactoryRecipeCursorUI Instance { get; private set; }
    ...
    private void Update()
    {
        if (!gameObject.activeSelf || canvas == null || root == null) return;
    ...
    public void Show(FoodRecipeData recipe)
    {
        if (iconImage != null)
