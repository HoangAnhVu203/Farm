...
public class SeedCursorUI : MonoBehaviour
{
    public static SeedCursorUI Instance { get; private set; }
    ...
    public void Show(CropSeedData seedData)
    {
        if (iconImage != null)
        {
            // bạn có thể thêm seed icon riêng vào CropSeedData
            // tạm dùng stage1Sprite làm icon
            iconImage.sprite = seedData != null ? seedData.seedIcon : null;
        }
